#ifndef _DebugRenderer_HG_
#define _DebugRenderer_HG_
...
public:
	...
	bool resizeBufferForAABBs(unsigned int newNumberAABB);
	void updateDebugAABBVerts(AABB_Center_Radius* theAABB, unsigned int AABBId);
private:
...
private:
	...
	sVAOInfoDebug m_VAOBufferInfoAABBs;
